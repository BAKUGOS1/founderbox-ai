...
import { Calendar, Github, Mail, Plug, Settings, Slack, StickyNote, UploadCloud } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Integrations are shown as frontend-ready cards. Real OAuth, sync jobs, and external data ingestion will be added in the backend phase."
      />
